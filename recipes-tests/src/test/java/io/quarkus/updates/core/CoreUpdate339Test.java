...
public class CoreUpdate339Test implements RewriteTest {
    ...
    public void defaults(RecipeSpec spec) {
        ...
        String recordRepository = """
                ...
                """;
        CoreTestUtil.recipe(spec, Path.of("quarkus-updates", "core", "3.39.alpha1.yaml"))
        ...
        rewriteRun(
                buildGradle(
                        """
                            ...
                            dependencies {
                                annotationProcessor enforcedPlatform("io.quarkus.platform:quarkus-bom:3.39.0")
